...
Новая редакционная стратегия канала:
- 70% тем: искусственный интеллект, нейросети, AI-агенты, автоматизация, роботы, цифровые сервисы, стартапы, бизнес и заработок через ИИ, необычные реальные кейсы применения ИИ, технологии будущего;
- 20% тем: наука, психология, исследования, космос, но только если тема полезна обычному человеку или связана с технологиями;
- 10% тем: история и необычные факты, но обязательно с мостиком к современности.

Требования к теме:
- тема должна звучать актуально прямо сейчас, а не как сухая энциклопедическая справка;
- формулируй через современный конфликт, пользу, кейс или неожиданный поворот;
- исторические темы разрешены только с явной связью с современностью: "Как телеграф XIX века предсказал интернет", а не "История телеграфа";
- не используй избитые научпоп-темы: чёрные дыры, динозавры, почему небо голубое, GPS, ДНК, атомы, квантовая запутанность, иммунитет, вакцины, Марс, Луна;
...
- формулируй конкретно: не "ИИ в бизнесе", а "Как маленькие магазины используют ИИ для ответов клиентам ночью";
- избегай одного и того же круга из общих тем про "будущее", "роботов" и "нейросети".
...
{{
  ...
  "category": "ai|automation|robots|digital_services|startup|business_ai|future_tech|science|psychology|space|modern_history",
